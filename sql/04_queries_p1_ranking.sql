...
-- Para qué: punto de partida del informe; muestra los 4 indicadores de España
-- Uso: Sección 7 (Resultados) del informe y tarjeta de contexto en Power BI
SELECT
...
-- Resultado esperado: Sin discapacidad 97.56% | Severa 79.30% | Brecha 18.26 pp
...
-- Para qué: responde P1; Lituania debe encabezar (35.86 pp), España 2ª (18.26 pp)
-- Uso: gráfico de barras horizontal del dashboard
WITH brecha AS (
...
-- Para qué: visión panorámica; fuente del heatmap del dashboard
SELECT
...
-- Para qué: narrativa de las conclusiones y diapositiva de cierre
SELECT
