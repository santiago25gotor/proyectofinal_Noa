...
--
-- RANKING POR BRECHA TOTAL (verificado con CSV real de Eurostat 2024):
--   1º Lituania  (LT):  35,86 pp
...
-- ── dim_age_group ─────────────────────────────────────────────────────────
-- Calidad de datos en Y16_24_DIS_SEV:
--   Nulo (muestra insuf.): ES, FR, LT, NL, SE
--   Valor con flag u:      DE, IT, PT
...
-- has_known_data_issues=1 indica observaciones con flag u o nulos conocidos
...
-- Por edad 16-24 (Y16_24_DIS_SEV tiene issues en todos los países)
...
-- Ranking: 1º LT (35,86 pp), 2º IT (18,27 pp), 3º ES (18,26 pp)
...
SELECT 'Países: ' || GROUP_CONCAT(country_code, ', ') AS paises
